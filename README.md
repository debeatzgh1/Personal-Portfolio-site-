...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const buttons = [
    {
      text: "🔥 subcr",
      link: "https://debeatzgh.wordpress.com/",
      bg: "#1e90ff"
    },
    {
      text: "💬 Sign",
      link: "https://docs.google.com/forms/d/e/1FAIpQLSdx2yQU28hg4L4Rm8rSdvjR4FZPpbys7XKEZDFul5yubv3Olg/viewform?usp=header",
      bg: "#28a745"
    },
    {
      text: "📄 Doc's",
      link: "https://docs.google.com/forms/d/e/1FAIpQLSfBDlR6TcU9sWjbeVOp6dtb4GMKdL6SP_i0KB08IrtbLT9wwA/viewform?usp=header",
      bg: "#ff6600"
    }
  ];
